...
import ActivityStepText from './ActivityStepText';
import ActivityStepNavigation from './ActivityStepNavigation';
import ActivitySummaryFooter from './ActivitySummaryFooter';
          ...
          <div className="d-flex flex-column w-100">
            <div className="d-flex justify-content-between align-items-start w-100">
              <div className="flex-grow-1"> 
                <ActivitySummaryHeader
                   layout="elog"
                   orderName={orderName}
                   activityName={activity.activity_name?.[language]}
            ...
            <div className="text-center mt-1">
              <h3 className="fw-bold mb-0">
                {activity?.activity_name?.[language]}
              </h3>
            </div>
          </div>
        ) : (
...
export default ActivityExecutionView;